...
<html>
    ...
    <body>
        ...
        <form method="post" action="ControleFuncionario">
            <input type="hidden" name="flag" value="CadastrarFuncionario"/>
            <p>
            ...
            <p>
                ...
                <input type="text" size="45" maxlength="45" name="cargo" id="cargo"/>
            </p>
            <p>
            ...
            <p>
                ...
                <select name="idDep" id="idDep">
                    ...
                    %>
                    <option value="<%= dep.getIdDep() %>"> <%= dep.getNomeDep() %> </option><!-- Exibe o NOME do departamento, porém envia o ID dele (value); -->
                    <%
                        }
                    %>
                </select>
