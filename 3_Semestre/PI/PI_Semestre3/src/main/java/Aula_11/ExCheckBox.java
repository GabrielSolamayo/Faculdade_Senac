...
public class ExCheckBox extends JFrame implements ItemListener{
	...
	ExCheckBox ()	{	
		...
		c1 = new JCheckBox("Negrito");c1.setBackground(new Color(180,180,180));c1.addItemListener(this);
		c2 = new JCheckBox("Italico");c2.setBackground(new Color(180,180,180));c2.addItemListener(this);
